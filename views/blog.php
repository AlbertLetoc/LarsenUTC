                    ...
                    <div class="col-md-12 news">
                        <div class="row news-title">
                            <div class="col-md-2 news-date">
                                <div class="row">
                                 <?php echo '<span class="news-date-day">'.date('d', strtotime($post['post_date'])).'</span><span class="news-date-month">'.utf8_encode(strftime('%b', strtotime($post['post_date']))).'</span><span class="news-date-year">'.date('Y', strtotime($post['post_date'])).'</span>'; ?>
                                </div>
                            </div>
                            <div class="col-md-10">
                        ...
                        <div class="row news-content">
                            <div class="col-md-2 news-author">
                                <img class="news-author-img" src="https://demeter.utc.fr/pls/portal30/portal30.get_photo_utilisateur?username=<?php echo $post['post_author']; ?>" alt="Photo auteur"/>
